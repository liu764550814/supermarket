...
<%@include file="/WEB-INF/jsp/common/head.jsp"%>
  ...
  <div class="right">
      ...
      <div align="center" style="color:red">${msg }</div>
          <form id="providerForm" name="providerForm" method="post" action="${pageContext.request.contextPath }/provider/saveupdateprovider.action"><!-- enctype="multipart/form-data" -->
...
<script type="text/javascript" src="${pageContext.request.contextPath }/statics/js/providermodify3.js"></script>