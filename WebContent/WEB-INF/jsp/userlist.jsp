	...
	<div class="search">
		<form method="POST"
			...
			<span>用户名：</span> <input name="queryname" class="input-text"
				...
				href="${pageContext.request.contextPath}/user/adduser.action">添加用户</a>
		</form>
	</div>
	<!--用户-->
	<table class="providerTable" cellpadding="0" cellspacing="0">
		...
		<c:forEach var="user" items="${userList}" varStatus="status">
			<tr>
				...
				<td><span>${user.age}</span></td><!-- user.age -->
				<td><span>${user.phone}</span></td>
				<td><span>${user.rolename}</span></td><!-- user.rolename -->
...
<script type="text/javascript"
	src="${pageContext.request.contextPath }/statics/js/userlist3.js"></script>
