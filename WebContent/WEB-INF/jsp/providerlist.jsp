...
<div class="right">
        ...
        <div class="search">
        	<form method="post" action="${pageContext.request.contextPath }/provider/providerlist.action"> <!-- enctype="multipart/form-data" -->
				<span>供应商编码：</span>
				...
				<a href="${pageContext.request.contextPath }/provider/provideradd.action">添加供应商</a>
			</form>
        </div>
        <!--供应商操作表格-->
