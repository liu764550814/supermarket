...
<div class="right">
        ...
        <div align="center" style="color:red">${msg }</div>
           <form id="providerForm" name="providerForm" method="post" action="${pageContext.request.contextPath }/provider/saveprovideradd.action"><!-- enctype="multipart/form-data" -->
...
<script type="text/javascript" src="${pageContext.request.contextPath }/statics/js/provideradd2.js"></script>
