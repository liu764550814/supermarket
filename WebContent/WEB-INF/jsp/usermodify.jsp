...
<div class="right">
	...
	<div class="providerAdd">
		...
		<form id="userForm" name="userForm" method="post"
			action="${pageContext.request.contextPath }/user/modifysave.action"><!-- enctype="multipart/form-data" -->
			<input type="hidden" name="userid" value="${user.id }" />
			<div>
				<label for="userName">用户编码：</label> <input type="text"
					name="usercode" value="${user.usercode }"><!-- readonly="readonly" -->
			</div>
			<div>
...
<script type="text/javascript"
	src="${pageContext.request.contextPath }/statics/js/usermodify2.js"></script>
