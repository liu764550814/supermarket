...
<div class="right">
     ...
     <div class="providerAdd">
         ...
         <form id="billForm" name="billForm" method="post" action="${pageContext.request.contextPath }/bill/savebill.action">
...
<script type="text/javascript" src="${pageContext.request.contextPath }/statics/js/billadd8.js"></script>