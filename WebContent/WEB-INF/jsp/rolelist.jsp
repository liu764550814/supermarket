...
<%@include file="/WEB-INF/jsp/common/head.jsp"%>
        <div class="right">
            ...
            <div class="search">
           		<a href="${pageContext.request.contextPath}/role/roleadd.action" >添加角色</a>
            </div>
...
<script type="text/javascript" src="/supermarket/statics/js/rolelist2.js"></script> <%--${pageContext.request.contextPath } --%>
